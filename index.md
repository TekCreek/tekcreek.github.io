...
<div style="margin: 10px 50px 10px 10px;"> 
  <h2><a href="https://www.youtube.com/c/tekcreek" target="_blank" rel="noopener">Youtube</a></h2>
</div>

<div style="margin: 10px 50px 10px 10px;">
  <h2><a href="https://www.udemy.com/user/purna-chandra-vidya-sagar-uppuluri/" target="_blank" rel="noopener">Udemy Profile</a></h2>
</div>
...
<div style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2);max-width: 300px; margin: 0px 0px 20px 0px;text-align: left;">
    <a href="https://www.udemy.com/course/object-oriented-programming-in-java/" target="_blank" rel="noopener">
      <img src="https://img-a.udemycdn.com/course/240x135/2181922_67c1_3.jpg" alt="Object Oriented Programming in JAVA" width="100%"/>
      <div style=" padding: 2px 16px;"><h3>Object Oriented Programming in JAVA</h3></div>
    </a>
